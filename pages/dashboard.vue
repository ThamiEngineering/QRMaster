                            ...
                            <div class="relative w-10 h-10">
                                ...
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round" class="w-5 h-5 text-yellow-400">
                ...
                <main class="flex-1 overflow-y-auto">
                    <div v-if="activeSection === 'dashboard'" class="p-8">
                        <div class="mb-12">
                            ...
                            <p class="text-xl text-white/60 leading-relaxed">Découvrez le meilleur de QRMaster avec des
                                outils de
                        ...
                        <div
                            ...
                            <div class="relative">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h2 class="text-2xl font-bold text-white mb-4">QRMaster vous propose des
                                            solutions rapides pour tous
                                            vos projets</h2>
                                        <p class="text-white/80 mb-8 text-lg">De la création jusqu'à l'analyse des
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div class="group relative p-6 rounded-2xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-white/10 transition-all duration-500 cursor-pointer"
                                ...
                                <div class="relative">
                                    ...
                                    <h3
                                        ...
                                        Créer un QR
                                        Code</h3>
                                    <p class="text-white/60 text-sm mb-4">Générez rapidement vos QR codes personnalisés
                                        avec tracking
                                        avancé</p>
                                    <div
                            ...
                            <div class="group relative p-6 rounded-2xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-white/10 transition-all duration-500 cursor-pointer"
                                ...
                                <div class="relative">
                                    ...
                                    <h3
                                        ...
                                        Analyser les
                                        performances</h3>
                                    <p class="text-white/60 text-sm mb-4">Suivez les scans et l'engagement en temps réel
                                        avec IA</p>
                                    <div
                            ...
                            <div class="group relative p-6 rounded-2xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-white/10 transition-all duration-500 cursor-pointer"
                                ...
                                <div class="relative">
                                    ...
                                    <h3
                                        ...
                                        Gérer vos
                                        campagnes</h3>
                                    <p class="text-white/60 text-sm mb-4">Organisez et optimisez vos campagnes QR avec
                                        IA</p>
                                    <div
                    ...
                    <div v-else-if="activeSection === 'my-qrcodes'" class="p-8">
                        ...
                        <div v-else-if="qrcodes.length === 0" class="flex flex-col items-center justify-center py-20">
                            ...
                            <p class="text-white/60 mb-8 text-center max-w-md">Commencez par créer votre premier QR code
                                et découvrez
                    ...
                    <div v-else-if="activeSection === 'help'" class="p-8">
                        <div class="mb-8">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="text-purple-400">
                    ...
                    <div v-else class="p-8">
                        <div class="mb-8">
                            ...
                            <h1 class="text-4xl font-bold text-white mb-4 tracking-tight">{{
                                getSectionTitle(activeSection) }}</h1>
                        ...
                        <div
                            ...
                            <div class="relative">
                                ...
                                <p class="text-white/60 max-w-md mx-auto">Notre équipe travaille activement sur cette
                                    section. Elle sera
