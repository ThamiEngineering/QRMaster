...
async function handleEditCampaign(campaignId: number, form: {
  name: string,
...
<template>
  <div class="relative min-h-screen bg-black text-white overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div class="absolute top-1/3 right-1/3 w-1 h-1 bg-yellow-400/20 rounded-full animate-ping"
           style="animation-delay: 1s;"></div>
      <div class="absolute bottom-1/4 left-1/3 w-3 h-3 bg-yellow-400/20 rounded-full animate-pulse"
           style="animation-delay: 2s;"></div>
      <div class="absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-yellow-400/30 rounded-full animate-ping"
    ...
    <div class="flex flex-col h-screen relative z-10">
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
              ...
              <button @click="showGenerateModal = true"
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                       stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"/>
      ...
      <div class="flex flex-1 overflow-hidden">
        <aside class="w-80 border-r border-white/10 backdrop-blur-xl bg-black/50 flex flex-col overflow-y-auto">
            ...
            <ul class="space-y-3">
              <li>
                <button @click="activeSection = 'dashboard'" :class="[
                                    ...
                                    activeSection === 'dashboard' ? 'bg-gradient-to-r from-yellow-400/10 to-amber-400/10 text-yellow-400 border border-yellow-400/20' : 'text-white/70 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10'
                                ]">
                  <div v-if="activeSection === 'dashboard'"
                       class="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-400/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
              ...
              <li>
                <button @click="activeSection = 'my-qrcodes'" :class="[
                                    'w-full text-left px-4 py-3 rounded-xl flex items-center space-x-3 transition-all duration-300 group relative overflow-hidden',
                                    activeSection === 'my-qrcodes' ? 'bg-gradient-to-r from-yellow-400/10 to-amber-400/10 text-yellow-400 border border-yellow-400/20' : 'text-white/70 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10'
                                ]">
                  <div v-if="activeSection === 'my-qrcodes'"
                       class="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-400/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                  <div class="relative flex items-center space-x-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <li>
                <button @click="activeSection = 'analytics'" :class="[
                                    'w-full text-left px-4 py-3 rounded-xl flex items-center space-x-3 transition-all duration-300 group relative overflow-hidden',
                                    activeSection === 'analytics' ? 'bg-gradient-to-r from-yellow-400/10 to-amber-400/10 text-yellow-400 border border-yellow-400/20' : 'text-white/70 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10'
                                ]">
              ...
              <li>
                <button @click="activeSection = 'campaigns'" :class="[
                                    'w-full text-left px-4 py-3 rounded-xl flex items-center space-x-3 transition-all duration-300 group relative overflow-hidden',
                                    activeSection === 'campaigns' ? 'bg-gradient-to-r from-yellow-400/10 to-amber-400/10 text-yellow-400 border border-yellow-400/20' : 'text-white/70 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10'
                                ]">
          ...
          <div class="p-6 border-t border-white/10">
            <button v-if="user" @click="activeSection = 'profile'" :class="[
                            ...
                            activeSection === 'profile' ? 'bg-gradient-to-r from-yellow-400/10 to-amber-400/10 text-yellow-400 border border-yellow-400/20' : 'text-white/70 hover:text-white hover:bg-white/5 border border-white/10 hover:border-white/20'
                        ]">
              ...
              <div class="relative flex items-center space-x-3 w-full">
                ...
                <div class="flex-1 text-left">
                  <p class="text-sm font-medium">
                    {{ userProfile?.first_name || user.user_metadata?.first_name || 'Utilisateur' }}</p>
                  <p class="text-xs text-white/50">{{ userProfile?.company_name || 'Mon profil' }}</p>
                </div>
              </div>
            </button>
        ...
        <main class="flex-1 overflow-y-auto">
          <div v-if="activeSection === 'dashboard'" class="p-8">
            <div class="mb-12">
              ...
              <p class="text-xl text-white/60 leading-relaxed">Découvrez le meilleur de QRMaster avec des outils de
            ...
            <div
              ...
              <div
                  class="absolute inset-0 bg-gradient-to-br opacity-20 from-yellow-500/20 via-amber-500/20 to-orange-500/20"></div>
              <div
                  class="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-400/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
              ...
              <div class="relative">
                <div class="flex items-start justify-between">
                  <div class="flex-1">
                    <h2 class="text-2xl font-bold text-white mb-4">QRMaster vous propose des solutions rapides pour tous
                      vos projets</h2>
                    <p class="text-white/80 mb-8 text-lg">De la création jusqu'à l'analyse des performances en temps
                      réel avec des outils d'intelligence artificielle intégrés.</p>
                    ...
                    <button @click="showGenerateModal = true"
                      ...
                      <div
                          class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                      <div
                          class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                  ...
                  <div class="relative w-64 h-32 hidden lg:block">
                    <div class="absolute top-4 right-8 w-16 h-16 bg-yellow-400/20 rounded-full animate-pulse"></div>
                    <div class="absolute bottom-8 right-16 w-10 h-10 bg-yellow-400/30 rounded-full animate-pulse"
                         style="animation-delay: 1s;"></div>
                    <div class="absolute top-12 right-24 w-6 h-6 bg-yellow-400/40 rounded-full animate-pulse"
                         style="animation-delay: 2s;"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-br opacity-20 from-yellow-500/10 via-amber-500/10 to-orange-500/10"></div>
                <div
                    class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative">
                  <div
                  ...
                  <h3 class="font-semibold text-white mb-2 group-hover:text-yellow-400 transition-colors">Créer un QR
                    Code</h3>
                  <p class="text-white/60 text-sm mb-4">Générez rapidement vos QR codes personnalisés avec tracking
                    avancé</p>
                  <div class="flex items-center text-yellow-400 font-medium text-sm group-hover:gap-2 transition-all">
                    <span>Commencer</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="transition-transform group-hover:translate-x-1">
              ...
              <div
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-br opacity-20 from-blue-500/10 via-indigo-500/10 to-purple-500/10"></div>
                <div
                    class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative">
                  <div
                  ...
                  <h3 class="font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors">Analyser les
                    performances</h3>
                  <p class="text-white/60 text-sm mb-4">Suivez les scans et l'engagement en temps réel avec IA</p>
                  <div class="flex items-center text-blue-400 font-medium text-sm group-hover:gap-2 transition-all">
              ...
              <div
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-br opacity-20 from-green-500/10 via-emerald-500/10 to-teal-500/10"></div>
                <div
                    class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative">
                  <div
                  ...
                  <h3 class="font-semibold text-white mb-2 group-hover:text-green-400 transition-colors">Gérer vos
                    campagnes</h3>
                  <p class="text-white/60 text-sm mb-4">Organisez et optimisez vos campagnes QR avec IA</p>
                  <div class="flex items-center text-green-400 font-medium text-sm group-hover:gap-2 transition-all">
                    <span>Gérer</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="transition-transform group-hover:translate-x-1">
          ...
          <div v-else-if="activeSection === 'my-qrcodes'" class="p-8">
            <div class="mb-8">
              ...
              <p class="text-white/60 text-lg">Gérez et analysez tous vos QR codes en un seul endroit</p>
            </div>
            ...
            <div v-else-if="qrcodes.length === 0" class="flex flex-col items-center justify-center py-20">
              <div class="relative mb-8">
                ...
                <div class="absolute -top-2 -right-2 w-6 h-6 bg-yellow-400/20 rounded-full animate-pulse"></div>
              </div>
              <h3 class="text-2xl font-bold text-white mb-4">Aucun QR code créé</h3>
              <p class="text-white/60 mb-8 text-center max-w-md">Commencez par créer votre premier QR code et découvrez
                la puissance de QRMaster</p>
              <button @click="showGenerateModal = true"
                      class="relative h-12 px-8 group overflow-hidden bg-gradient-to-r from-yellow-400 via-yellow-500 to-amber-500 hover:from-yellow-500 hover:via-amber-500 hover:to-orange-500 text-black rounded-xl border border-yellow-400/20 shadow-lg hover:shadow-yellow-400/25 transition-all duration-500 ease-out">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <div v-else-if="activeSection === 'analytics'" class="p-8">
            <div class="mb-8">
              ...
              <p class="text-white/60 text-lg">Suivez les performances de vos QR codes en temps réel</p>
            </div>
          ...
          <div v-else-if="activeSection === 'profile'" class="p-8">
            <div class="mb-8">
              ...
              <p class="text-white/60 text-lg">Gérez vos informations personnelles et préférences</p>
            </div>
          ...
          <div v-else class="p-8">
            <div class="mb-8">
              ...
              <h1 class="text-4xl font-bold text-white mb-4 tracking-tight">{{ getSectionTitle(activeSection) }}</h1>
            ...
            <div
              ...
              <div
                  class="absolute inset-0 bg-gradient-to-br opacity-20 from-gray-500/10 via-slate-500/10 to-zinc-500/10"></div>
              <div class="relative">
                <div
                ...
                <h3 class="text-xl font-semibold text-white mb-4">Fonctionnalité en développement</h3>
                <p class="text-white/60 max-w-md mx-auto">Notre équipe travaille activement sur cette section. Elle sera
                  disponible dans une prochaine mise à jour.</p>
              </div>
            </div>
          </div>
        </main>
      ...
      <CampaignCreateModal :is-open="showCreateCampaignModal" :is-creating="isCreatingCampaign"
                           @update:is-open="showCreateCampaignModal = $event" @create="handleCreateCampaign"
                           @reset="() => { }"/>
    </div>
  </div>
</template>
