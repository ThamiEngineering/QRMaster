      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="hidden md:flex items-center gap-4">
            <NuxtLink to="/register" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-zinc-950 dark:focus-visible:ring-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 h-10 px-4 py-2 text-white/70 hover:text-white hover:bg-white/5" aria-label="Créer un compte">
              Créer un compte
            </NuxtLink>
          </div>
        </div>
          ...
          <div style="opacity: 1; transform: none;">
            ...
            <div class="space-y-8">
              <h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tighter leading-[0.95]" style="opacity: 1; transform: none;">
                ...
                <span class="block mt-4 text-yellow-400 relative" style="opacity: 1; transform: none;">
                                    <span class="relative z-10">QRMaster</span>
                                    <div class="absolute inset-0 bg-yellow-400/10 blur-3xl -z-10 animate-pulse"></div>
                                </span>
              </h1>
              <p class="text-xl text-white/60 max-w-2xl mx-auto leading-relaxed" style="opacity: 1; transform: none;">
                Connectez-vous à votre espace et gérez vos QR codes avec la technologie de nouvelle génération.
              </p>
            </div>
          </div>
        </div>
              ...
              <form @submit.prevent="handleLogin" class="space-y-6">
                ...
                <div class="space-y-2">
                  ...
                  <div class="text-right">
                    <a href="#" class="text-sm text-white/60 hover:text-yellow-400 transition-colors">
                      Mot de passe oublié ?
                    </a>
                  </div>
                </div>
