...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Créez votre compte QRMaster et commencez à gérer vos QR codes.',
    },
  ],
})
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        <div class="text-center max-w-4xl mx-auto mb-16">
          <div style="opacity: 1; transform: none">
            ...
            <div class="space-y-6">
              <h1
                class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tighter leading-[0.95]"
                style="opacity: 1; transform: none"
              >
                <span class="inline-block" style="opacity: 1; transform: none">Créez votre</span>
                <span
                  class="block mt-3 text-yellow-400 relative"
                  style="opacity: 1; transform: none"
                >
              ...
              <p
                class="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed"
                style="opacity: 1; transform: none"
              >
                Rejoignez des milliers d'utilisateurs qui font confiance à QRMaster pour gérer leurs
                QR codes professionnels.
              </p>
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  <label for="terms" class="text-sm text-white/80 cursor-pointer">
                    ...
                    >
                      ...
                      <span
                        class="absolute -bottom-0.5 left-0 w-0 h-px bg-yellow-400 transition-all group-hover:w-full"
                      />
                    </a>
                    et la
                    <a
