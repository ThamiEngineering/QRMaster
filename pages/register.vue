...
<template>
  <div class="relative min-h-screen bg-black text-white overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none select-none">
      ...
      <div class="absolute -right-4 top-1/2 -translate-y-1/2 -rotate-180 text-white/[0.03] text-[20rem] font-bold tracking-tighter [writing-mode:vertical-rl] blur-[1px]">
        REGISTER
      </div>
    </div>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <NuxtLink to="/" class="text-xl font-medium tracking-tight flex items-center gap-2" aria-label="QRMaster Homepage">
            <div class="relative w-8 h-8">
              <div class="absolute inset-0 bg-yellow-400/20 rounded-xl blur-sm"></div>
              <div class="relative w-full h-full rounded-xl bg-black border border-yellow-400/20 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 text-yellow-400">
          ...
          <div class="hidden md:flex items-center gap-4">
            <NuxtLink to="/login" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-zinc-950 dark:focus-visible:ring-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 h-10 px-4 py-2 text-white/70 hover:text-white hover:bg-white/5" aria-label="Se connecter">
              Se connecter
            </NuxtLink>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        <div class="text-center max-w-4xl mx-auto mb-16">
          <div style="opacity: 1; transform: none;">
            ...
            <!-- Title -->
            <div class="space-y-6">
              <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tighter leading-[0.95]" style="opacity: 1; transform: none;">
              ...
              <p class="text-lg text-white/60 max-w-2xl mx-auto leading-relaxed" style="opacity: 1; transform: none;">
                Rejoignez des milliers d'utilisateurs qui font confiance à QRMaster pour gérer leurs QR codes professionnels.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flex justify-center">
          <div class="group relative w-full max-w-lg p-8 rounded-2xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-2xl transition-all duration-500 ease-out">
            ...
            <div class="relative space-y-6">
              ...
              <div v-if="errorMessage" class="relative p-4 rounded-xl overflow-hidden bg-gradient-to-br from-red-500/10 via-red-500/5 to-red-500/10 backdrop-blur-md border border-red-500/20">
                ...
                <div class="relative flex items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-red-400 shrink-0">
              ...
              <form @submit.prevent="handleRegister" class="space-y-5">
                  ...
                  <div class="space-y-2">
                    ...
                    <div class="relative">
                      <input
                          ...
                          placeholder="Prénom"
                      />
                      <div class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-yellow-400/50 to-transparent opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
                    </div>
                  </div>
                ...
                <!-- Terms Checkbox -->
                <div class="flex items-start space-x-3 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05]">
                  <div class="relative">
                    <input
                        type="checkbox"
                        id="terms"
                    ...
                    />
                    <div
                        @click="form.acceptTerms = !form.acceptTerms"
                    ...
                    >
                      <svg v-if="form.acceptTerms" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="text-black">
                  ...
                  <label for="terms" class="text-sm text-white/80 cursor-pointer">
                    J'accepte les
                    <a href="#" class="text-yellow-400 hover:text-yellow-300 transition-colors font-medium relative group">
                      conditions d'utilisation
                      <span class="absolute -bottom-0.5 left-0 w-0 h-px bg-yellow-400 transition-all group-hover:w-full"></span>
                    </a>
                    et la
                    <a href="#" class="text-yellow-400 hover:text-yellow-300 transition-colors font-medium relative group">
                ...
                <!-- Captcha-like -->
                <div class="flex items-center space-x-3 p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                  <div class="w-6 h-6 bg-green-400 rounded-md flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-green-900">
                      <polyline points="20,6 9,17 4,12"/>
                    </svg>
                  </div>
                ...
                >
                  ...
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                  <div class="relative flex items-center justify-center gap-3">
                    ...
                    <svg v-if="!loading" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:translate-x-1">
                      <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/>
                      <circle cx="9" cy="7" r="4"/>
                      <path d="m22 2-5 5"/>
                      <path d="m17 7 5-5"/>
                    </svg>
                    <svg v-else class="animate-spin" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="text-center pt-4">
                  ...
                  <NuxtLink to="/login" class="text-yellow-400 hover:text-yellow-300 font-medium transition-colors relative group">
                    Se connecter
                    <span class="absolute -bottom-1 left-0 w-0 h-px bg-yellow-400 transition-all group-hover:w-full"></span>
                  </NuxtLink>
                </div>
              </form>
            </div>
    ...
    <footer class="absolute bottom-0 right-0 p-6 z-10">
      <div class="flex flex-wrap gap-4 text-xs text-white/40">
        <a href="#" class="hover:text-white/70 transition-colors relative group">
          ...
          <span class="absolute -bottom-1 left-0 w-0 h-px bg-white/50 transition-all group-hover:w-full"></span>
        </a>
        <a href="#" class="hover:text-white/70 transition-colors relative group">
          Besoin d'aide ?
          <span class="absolute -bottom-1 left-0 w-0 h-px bg-white/50 transition-all group-hover:w-full"></span>
