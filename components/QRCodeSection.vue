          ...
          <div class="flex items-center gap-4 mb-4">
            ...
            <div>
              <p class="text-2xl font-bold text-white">
                {{ qrcodesWithImages.reduce((sum, qr) => sum + (qr.scan_count || 0), 0) }}
              </p>
      ...
      >
        ...
        <div class="relative">
          <div class="flex items-center gap-4 mb-4">
            ...
            <div>
              <p class="text-2xl font-bold text-white">
                {{ qrcodesWithImages.filter((qr) => qr.type === 'dynamique').length }}
              </p>
      ...
      >
        ...
        <div class="relative p-6 flex flex-col h-full">
          ...
          <div class="mb-6 flex justify-center">
            <div class="relative">
              <div
                class="p-4 bg-white rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow duration-300"
              >
                ...
                <div
                  v-else
                  class="w-24 h-24 flex items-center justify-center bg-gray-100 rounded-lg"
                >
                  <svg
            ...
            <div
              class="absolute top-2 right-2 px-2 py-1 text-xs font-semibold rounded-full bg-green-400/20 text-green-400 border border-green-400/30"
            >
              Actif
            </div>
          </div>
          ...
          <div class="flex-grow space-y-4">
            ...
            <div>
              <h3
                class="font-bold text-lg text-white group-hover:text-yellow-400 transition-colors duration-300 line-clamp-2"
              >
                {{ qr.name }}
              </h3>
            ...
            <div class="flex flex-wrap gap-2">
              ...
              >
                <svg
                  ...
                  class="mr-1"
                >
                  <rect v-if="qr.type === 'statique'" width="5" height="5" x="3" y="3" rx="1" />
                  <path v-else d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" />
                  <path v-if="qr.type === 'dynamique'" d="M3 3v5h5" />
                  <path
                    v-if="qr.type === 'dynamique'"
                    d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"
                  />
                  <path v-if="qr.type === 'dynamique'" d="M16 16h5v5" />
                </svg>
                {{ qr.type }}
              </span>
              ...
              <span
                ...
                class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-400/10 text-yellow-400 border border-yellow-400/20"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12"
            ...
            <!-- Stats -->
            <div
              class="flex justify-between items-center text-xs text-white/50 border-t border-white/10 pt-4"
            >
          ...
          >
            <!-- Share Button -->
            <button
              class="flex-1 relative overflow-hidden bg-gradient-to-r from-indigo-400/20 to-purple-400/20 border border-indigo-400/30 text-indigo-400 text-xs font-medium py-2.5 px-3 rounded-xl hover:from-indigo-400/30 hover:to-purple-400/30 hover:border-indigo-400/40 transition-all duration-300 group/btn"
            ...
            <!-- Edit Button -->
            <button
              class="flex-1 relative overflow-hidden bg-gradient-to-r from-blue-400/20 to-cyan-400/20 border border-blue-400/30 text-blue-400 text-xs font-medium py-2.5 px-3 rounded-xl hover:from-blue-400/30 hover:to-cyan-400/30 hover:border-blue-400/40 transition-all duration-300 group/btn"
