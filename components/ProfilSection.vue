...
<template>
  <div class="space-y-8">
    <div v-if="isOfflineMode" class="p-4 rounded-xl bg-gradient-to-r from-yellow-400/10 to-amber-400/10 border border-yellow-400/20">
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-white/70">Connexion limitée. Certaines fonctionnalités peuvent être indisponibles.</p>
        </div>
      </div>
    </div>

    <div v-if="isLoading" class="flex flex-col items-center justify-center py-20">
      <div class="w-16 h-16 bg-indigo-400/10 border border-indigo-400/20 rounded-2xl flex items-center justify-center mb-6">
    ...
    <div v-else-if="profile" class="space-y-8">
      <div class="group relative p-6 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
        ...
        <div class="relative">
          <div class="flex items-center justify-between mb-6">
            ...
            <button v-if="!isEditing" @click="startEditing" class="relative h-10 px-4 group overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 rounded-xl text-white/90 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300">
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
          ...
          <div v-if="!isEditing" class="space-y-6">
            <div class="flex items-center space-x-6">
              <div class="w-20 h-20 bg-gradient-to-br from-indigo-400/20 to-purple-400/20 rounded-2xl flex items-center justify-center border border-indigo-400/20">
          ...
          <form v-else @submit.prevent="saveProfile" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <div class="relative">
                  ...
                  />
                  <div class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-indigo-400/50 to-transparent opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
            ...
            <div class="flex gap-4 pt-4">
              ...
              <button type="button" @click="cancelEditing" class="relative h-12 px-6 group overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 rounded-xl text-white/90 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18"/>
      ...
      <div class="group relative p-6 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
        <div class="absolute inset-0 bg-gradient-to-br opacity-20 from-blue-500/10 via-cyan-500/10 to-teal-500/10"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
      ...
      <div class="group relative p-6 rounded-xl overflow-hidden bg-gradient-to-br from-red-500/5 via-red-500/10 to-rose-500/5 backdrop-blur-md border border-red-500/20 hover:border-red-500/30 transition-all duration-300">
        <div class="absolute inset-0 bg-gradient-to-br opacity-20 from-red-500/10 via-rose-500/10 to-pink-500/10"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-transparent via-red-500/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
        ...
        <div class="relative">
          ...
          <button @click="showDeleteModal = true" :disabled="isOfflineMode" class="relative h-12 px-6 group overflow-hidden bg-gradient-to-r from-red-500 via-red-600 to-rose-600 hover:from-red-600 hover:via-rose-600 hover:to-pink-600 text-white rounded-xl border border-red-500/20 shadow-lg hover:shadow-red-500/25 transition-all duration-500 ease-out disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
            <div class="relative flex items-center justify-center gap-3">
