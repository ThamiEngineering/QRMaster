  ...
  <div v-if="modalOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-2xl rounded-2xl overflow-hidden bg-black border border-white/20 shadow-2xl">
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-4 -right-4 w-32 h-32 bg-green-400/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-4 -left-4 w-24 h-24 bg-green-400/5 rounded-full blur-2xl"></div>
      </div>
        ...
        <form @submit.prevent="handleCreate" class="space-y-6">
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              />
              <div
                  class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-green-400/50 to-transparent opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
            </div>
          </div>
          ...
          <div class="p-4 rounded-xl bg-gradient-to-r from-green-400/5 to-emerald-400/5 border border-green-400/20">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <h4 class="text-sm font-medium text-green-400 mb-1">Conseils pour une campagne efficace</h4>
      ...
      <div class="relative border-t border-white/10 p-6">
        <div class="flex justify-end gap-4">
          <button @click="handleReset" :disabled="isCreating"
          ...
          <button @click="handleCreate" :disabled="isCreating || !campaignData.name"
            ...
            <div class="relative flex items-center justify-center gap-3">
              ...
              <svg v-if="!isCreating" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
