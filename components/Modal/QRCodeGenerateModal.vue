  ...
  <div v-if="modalOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-2xl rounded-2xl overflow-hidden bg-black border border-white/20 shadow-2xl">
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-4 -left-4 w-24 h-24 bg-yellow-400/5 rounded-full blur-2xl"></div>
      </div>
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-white/60 text-sm">Créez votre QR code personnalisé avec tracking avancé</p>
            </div>
          </div>
        ...
        <form @submit.prevent="handleCreate" class="space-y-6">
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              />
              <div
                  class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-yellow-400/50 to-transparent opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
            </div>
          </div>
      ...
      <div class="relative border-t border-white/10 p-6">
        <div class="flex justify-end gap-4">
          ...
          <button @click="handleCreate" :disabled="isCreating || !qrCodeData.name || !qrCodeData.content"
