...
<template>
  <div v-if="modalOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-lg rounded-2xl overflow-hidden bg-black border border-white/20 shadow-2xl">
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-4 -right-4 w-32 h-32 bg-indigo-400/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-4 -left-4 w-24 h-24 bg-indigo-400/5 rounded-full blur-2xl"></div>
      </div>

      <div class="relative border-b border-white/10 p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 bg-indigo-400/10 border border-indigo-400/20 rounded-xl flex items-center justify-center">
      ...
      <div class="relative p-6 space-y-8 overflow-auto max-h-[70vh]">
        <div v-if="selectedQR && qrCodeImage" class="flex flex-col items-center">
          <div class="p-4 bg-white rounded-2xl shadow-2xl mb-4 relative group">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
          </div>
          ...
          <div class="text-center space-y-2">
            ...
            <div class="flex items-center justify-center gap-4 text-sm text-white/60">
              ...
              <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" :class="{
                                'bg-blue-400/10 text-blue-400 border border-blue-400/20': selectedQR.type === 'dynamique',
                                'bg-gray-400/10 text-gray-400 border border-gray-400/20': selectedQR.type === 'statique'
                            }">
                                {{ selectedQR.type }}
                            </span>
            </div>
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4">
            <button @click="handleCopyToClipboard" class="group relative p-4 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
              ...
              <div class="relative flex items-center gap-4">
                <div class="w-12 h-12 bg-blue-400/10 border border-blue-400/20 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div class="flex-1 text-left">
                  <h4 class="font-medium text-white group-hover:text-blue-400 transition-colors">Copier le lien</h4>
                  <p class="text-sm text-white/60">Partagez l'URL de tracking directement</p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white/40 group-hover:text-blue-400 transition-all group-hover:translate-x-1">
                  <path d="m9 18 6-6-6-6"/>
                </svg>
              </div>
            </button>

            <button @click="handleDownload" class="group relative p-4 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
              <div class="absolute inset-0 bg-gradient-to-br opacity-20 from-green-500/10 via-emerald-500/10 to-teal-500/10"></div>
              <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
              <div class="relative flex items-center gap-4">
                <div class="w-12 h-12 bg-green-400/10 border border-green-400/20 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div class="flex-1 text-left">
                  <h4 class="font-medium text-white group-hover:text-green-400 transition-colors">Télécharger le QR code</h4>
                  <p class="text-sm text-white/60">Sauvegardez l'image en haute qualité</p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white/40 group-hover:text-green-400 transition-all group-hover:translate-x-1">
                  <path d="m9 18 6-6-6-6"/>
                </svg>
              </div>
            </button>
          ...
          <div class="pt-4 border-t border-white/10">
            ...
            <div class="grid grid-cols-4 gap-3">
              <button class="group relative p-3 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex flex-col items-center gap-2">
                  <div class="w-8 h-8 bg-red-400/10 border border-red-400/20 rounded-lg flex items-center justify-center">
                  ...
                  <span class="text-xs text-white/70 group-hover:text-red-400 transition-colors">Email</span>
                </div>
              </button>
              ...
              <button class="group relative p-3 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex flex-col items-center gap-2">
                  <div class="w-8 h-8 bg-emerald-400/10 border border-emerald-400/20 rounded-lg flex items-center justify-center">
                  ...
                  <span class="text-xs text-white/70 group-hover:text-emerald-400 transition-colors">WhatsApp</span>
                </div>
              </button>
              ...
              <button class="group relative p-3 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex flex-col items-center gap-2">
                  <div class="w-8 h-8 bg-blue-600/10 border border-blue-600/20 rounded-lg flex items-center justify-center">
                  ...
                  <span class="text-xs text-white/70 group-hover:text-blue-400 transition-colors">LinkedIn</span>
                </div>
              </button>
              ...
              <button class="group relative p-3 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-300">
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"></div>
                <div class="relative flex flex-col items-center gap-2">
                  <div class="w-8 h-8 bg-sky-400/10 border border-sky-400/20 rounded-lg flex items-center justify-center">
                  ...
                  <span class="text-xs text-white/70 group-hover:text-sky-400 transition-colors">Twitter</span>
                </div>
              </button>
            </div>
          </div>

          <div class="p-4 rounded-xl bg-gradient-to-r from-indigo-400/5 to-purple-400/5 border border-indigo-400/20">
            <div class="flex items-start gap-3">
              <div class="w-6 h-6 bg-indigo-400/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
