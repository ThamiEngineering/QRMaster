      ...
      <div class="relative p-6 space-y-6">
        ...
        <div class="p-4 rounded-xl bg-gradient-to-r from-red-400/10 to-rose-400/10 border border-red-400/20">
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-white/70">Ce QR code sera définitivement supprimé. Toutes ses données et statistiques seront perdues.</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-4 rounded-xl bg-white/5 border border-white/10">
          <div class="flex items-start justify-between">
            ...
            <div class="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center flex-shrink-0 ml-4">
        ...
        <div class="flex justify-end gap-4">
          ...
          <button @click="handleConfirmDelete" :disabled="isDeleting" class="relative h-12 px-8 group overflow-hidden bg-gradient-to-r from-red-500 via-red-600 to-rose-600 hover:from-red-600 hover:via-rose-600 hover:to-pink-600 text-white rounded-xl border border-red-500/20 shadow-lg hover:shadow-red-500/25 transition-all duration-500 ease-out disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="relative flex items-center justify-center gap-3">
              ...
              <svg v-if="!isDeleting" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:scale-110">
                <path d="M3 6h18"/>
                <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/>
                <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/>
                <line x1="10" x2="10" y1="11" y2="17"/>
