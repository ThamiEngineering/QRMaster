    ...
    <div class="relative w-full max-w-2xl rounded-2xl overflow-hidden bg-black border border-white/20 shadow-2xl">
      ...
      <div class="relative p-6 overflow-auto max-h-[70vh]">
        <form @submit.prevent="handleEdit" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              >
                ...
                <option v-for="campaign in campaigns" :key="campaign.id" :value="campaign.id" class="bg-gray-800 text-white">
                  {{ campaign.name }}
                </option>
              </select>
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <label class="relative cursor-pointer">
                ...
                <div :class="[
                  ...
                  <p class="text-xs opacity-80">Modifiable après création, avec analytics avancés</p>
                </div>
              </label>
            </div>
          </div>
          ...
          <!-- Current QR Info -->
          <div class="p-4 rounded-xl bg-gradient-to-r from-blue-400/5 to-indigo-400/5 border border-blue-400/20">
            <div class="flex items-start gap-3">
              <div class="w-6 h-6 bg-blue-400/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div class="flex-1">
                ...
                <div class="space-y-1 text-xs text-white/70">
                  ...
                  <div class="flex items-center justify-between">
                    <span>Créé le :</span>
                    <span class="font-medium text-white/90">{{ selectedQR ? new Date(selectedQR.created_at).toLocaleDateString('fr-FR') : '' }}</span>
                  </div>
                  <div v-if="editForm.content !== selectedQR?.content" class="flex items-center gap-2 mt-2 p-2 bg-yellow-400/10 border border-yellow-400/20 rounded-lg">
                    ...
                    <span class="text-yellow-400 text-xs">Le contenu a été modifié - un nouveau QR code sera généré</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Modification Tips -->
          <div class="p-4 rounded-xl bg-gradient-to-r from-green-400/5 to-emerald-400/5 border border-green-400/20">
            <div class="flex items-start gap-3">
              <div class="w-6 h-6 bg-green-400/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div class="flex justify-end gap-4">
          ...
          >
            <div class="relative flex items-center justify-center gap-3">
              ...
              <svg v-if="!isEditing" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:scale-110">
                <path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/>
                <path d="m15 5 4 4"/>
              </svg>
