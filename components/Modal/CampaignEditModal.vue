...
<template>
  <div v-if="modalOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-2xl rounded-2xl overflow-hidden bg-black border border-white/20 shadow-2xl">
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-4 -right-4 w-32 h-32 bg-amber-400/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-4 -left-4 w-24 h-24 bg-amber-400/5 rounded-full blur-2xl"></div>
      </div>

      <div class="relative border-b border-white/10 p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 bg-amber-400/10 border border-amber-400/20 rounded-xl flex items-center justify-center">
          ...
          <button @click="handleCancel" class="w-10 h-10 rounded-xl flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-all duration-200">
        ...
        <form @submit.prevent="handleEdit" class="space-y-6">
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              />
              <div class="absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-amber-400/50 to-transparent opacity-0 focus-within:opacity-100 transition-opacity duration-300"></div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-3 gap-3">
              <label class="relative cursor-pointer">
                ...
                <div :class="[
                  ...
                  <div class="w-8 h-8 mx-auto mb-2 rounded-lg flex items-center justify-center" :class="editForm.status === 'active' ? 'bg-green-400/20' : 'bg-white/10'">
              ...
              <label class="relative cursor-pointer">
                ...
                <div :class="[
                  ...
                  <div class="w-8 h-8 mx-auto mb-2 rounded-lg flex items-center justify-center" :class="editForm.status === 'paused' ? 'bg-yellow-400/20' : 'bg-white/10'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <label class="relative cursor-pointer">
                ...
                <div :class="[
                  ...
                  <div class="w-8 h-8 mx-auto mb-2 rounded-lg flex items-center justify-center" :class="editForm.status === 'archived' ? 'bg-gray-400/20' : 'bg-white/10'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="p-4 rounded-xl bg-gradient-to-r from-amber-400/5 to-orange-400/5 border border-amber-400/20">
            <div class="flex items-start gap-3">
              <div class="w-6 h-6 bg-amber-400/20 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div class="flex justify-end gap-4">
          ...
          <button @click="handleEdit" :disabled="isEditing || !editForm.name" class="relative h-12 px-8 group overflow-hidden bg-gradient-to-r from-amber-400 via-amber-500 to-orange-500 hover:from-amber-500 hover:via-orange-500 hover:to-red-500 text-black rounded-xl border border-amber-400/20 shadow-lg hover:shadow-amber-400/25 transition-all duration-500 ease-out disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="relative flex items-center justify-center gap-3">
              ...
              <svg v-if="!isEditing" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:translate-x-1">
                <path d="M12 20h9"/>
                <path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/>
                <path d="m15 5 3 3"/>
              </svg>
