...
watch(() => props.selectedCampaign, (newCampaign) => {
    if (newCampaign) {
        editForm.value = {
        ...
        <template #body>
            <form @submit.prevent="handleEdit" class="space-y-4">
                <div>
                    ...
                    <UInput id="edit-campaign-name" v-model="editForm.name" placeholder="Ma campagne marketing" required />
                </div>

                <div>
                    <label for="edit-campaign-description" class="block text-sm font-medium text-gray-700 mb-1">
                        Description (optionnel)
                    </label>
                    <UTextarea id="edit-campaign-description" v-model="editForm.description"
                ...
                <div>
                    ...
                    <USelect id="edit-campaign-status" v-model="editForm.status" :items="[
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" id="edit-campaign-start" v-model="editForm.start_date"
                    ...
                    <div>
                        ...
                        <input type="date" id="edit-campaign-end" v-model="editForm.end_date"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent" />
                    </div>
                </div>
            </form>
