  ...
  <div class="space-y-8">
    <div class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div
          ...
          :key="guide.title"
          class="group relative p-6 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-white/10 transition-all duration-500 cursor-pointer"
        >
          <div
            :class="`absolute inset-0 bg-gradient-to-br opacity-20 from-${guide.color}-500/10 via-${guide.color}-500/5 to-${guide.color}-500/10`"
          />
          <div
          ...
          <div class="relative">
            <div
              :class="`w-12 h-12 bg-${guide.color}-400/10 border border-${guide.color}-400/20 rounded-xl flex items-center justify-center mb-4 group-hover:bg-${guide.color}-400/20 group-hover:border-${guide.color}-400/30 transition-all duration-300`"
            >
              <svg
        ...
        <div class="space-y-4">
          ...
          <div v-else class="space-y-3">
            <div v-for="(item, index) in filteredFAQ" :key="index" class="group">
              <button
                class="w-full p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-200 text-left"
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          class="group relative p-6 rounded-xl overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-white/10 transition-all duration-500 cursor-pointer text-center"
        >
          <div
          ...
          <div class="relative">
            <div
              class="w-16 h-16 bg-indigo-400/10 border border-indigo-400/20 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-indigo-400/20 group-hover:border-indigo-400/30 transition-all duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
            ...
            <h3 class="font-semibold text-white mb-2 group-hover:text-indigo-400 transition-colors">
              Tutoriels vidéo
            </h3>
            <p class="text-white/60 text-sm mb-4">Apprenez avec nos guides vidéo pas à pas</p>
            <button
              class="relative h-10 px-4 group/btn overflow-hidden bg-gradient-to-br from-white/[0.03] via-white/[0.05] to-white/[0.03] backdrop-blur-md border border-white/10 rounded-xl text-white/90 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300"
            >
              <div
                class="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.08] to-transparent opacity-0 group-hover/btn:opacity-100 -translate-x-full group-hover/btn:translate-x-full transition-all duration-1000"
              />
        ...
        >
          ...
          <div class="relative">
            <div
              class="w-16 h-16 bg-green-400/10 border border-green-400/20 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-green-400/20 group-hover:border-green-400/30 transition-all duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
            ...
            <h3 class="font-semibold text-white mb-2 group-hover:text-green-400 transition-colors">
              Documentation
            </h3>
        ...
        >
          ...
          <div class="relative">
            <div
              class="w-16 h-16 bg-purple-400/10 border border-purple-400/20 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-400/20 group-hover:border-purple-400/30 transition-all duration-300"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
    ...
    <div
      class="group relative p-8 rounded-xl overflow-hidden bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20 hover:border-blue-500/30 transition-all duration-300"
    >
      <div
        class="absolute inset-0 bg-gradient-to-br opacity-20 from-blue-500/10 via-indigo-500/10 to-purple-500/10"
      />
      <div
        class="absolute inset-0 bg-gradient-to-r from-transparent via-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-1000"
      />
      ...
      <div class="relative">
        <div class="flex items-center justify-between">
          <div class="flex-1">
            ...
            <button
              class="relative h-12 px-8 group/contact overflow-hidden bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-500 hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 text-white rounded-xl border border-blue-400/20 shadow-lg hover:shadow-blue-400/25 transition-all duration-500 ease-out"
            >
              <div
                class="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover/contact:opacity-100 transition-opacity duration-500"
              />
              <div
                class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover/contact:opacity-100 -translate-x-full group-hover/contact:translate-x-full transition-all duration-1000"
              />
          ...
          <div class="hidden md:block ml-8">
            <div
              class="w-24 h-24 bg-blue-400/10 border border-blue-400/20 rounded-2xl flex items-center justify-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
