...
const faqItems = ref([
    {
        ...
        answer: "Cliquez sur le bouton 'Générer' en haut de la page, remplissez les informations requises (nom, contenu) et cliquez sur 'Générer'. Votre QR code sera créé instantanément.",
        category: "getting-started"
    },
    {
        id: 2,
        question: "Quelle est la différence entre QR code statique et dynamique ?",
        answer: "Un QR code statique contient directement l'information finale (URL, texte). Un QR code dynamique redirige vers une URL que vous pouvez modifier sans changer le QR code physique.",
        category: "qr-codes"
    },
    {
        id: 3,
        question: "Comment organiser mes QR codes en campagnes ?",
        answer: "Les campagnes vous permettent de grouper vos QR codes par projet ou thématique. Créez une campagne via le bouton 'Nouvelle campagne', puis assignez vos QR codes à cette campagne lors de leur création.",
        category: "campaigns"
    },
    {
        id: 4,
        question: "Comment voir les statistiques de mes QR codes ?",
        answer: "Rendez-vous dans la section 'Analyses' pour voir les statistiques détaillées de vos QR codes : nombre de scans, géolocalisation, appareils utilisés, etc.",
        category: "analytics"
    },
    {
        id: 5,
        question: "Puis-je télécharger mes QR codes ?",
        answer: "Oui ! Dans la section 'Mes QR codes', cliquez sur le bouton de partage de n'importe quel QR code, puis sur 'Télécharger' pour sauvegarder l'image.",
        category: "qr-codes"
    },
    {
        id: 6,
        question: "Comment modifier un QR code existant ?",
        answer: "Seuls les QR codes dynamiques peuvent être modifiés. Cliquez sur l'icône de modification dans la liste de vos QR codes pour changer le contenu, le nom ou la campagne associée.",
        category: "qr-codes"
    }
])
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div v-for="guide in guides" :key="guide.title"
                    ...
                    <div class="flex items-center mb-3">
                        <div :class="`w-10 h-10 rounded-lg flex items-center justify-center bg-${guide.color}-100`">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                <div v-if="filteredFAQ.length === 0" class="text-center py-8">
                    <Icon name="i-heroicons-question-mark-circle" class="w-12 h-12 text-gray-400 mx-auto mb-3" />
                    <p class="text-gray-500">Aucune question trouvée pour votre recherche.</p>
                </div>
                
                <div v-else>
                    <UAccordion :items="filteredFAQ.map(item => ({
                        label: item.question,
                        content: item.answer,
                        defaultOpen: false
                    }))" />
        ...
        <div class="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mb-4">Notre équipe support est là pour vous aider à réussir avec QRMaster.</p>
                    <div class="flex gap-3">
                        <UButton color="primary" icon="i-heroicons-envelope">
